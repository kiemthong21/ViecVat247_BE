...
{
    public class CustomerRoomConfiguration : IEntityTypeConfiguration<CustomerRoom>
    {
        public void Configure(EntityTypeBuilder<CustomerRoom> builder)
        {
            builder.ToTable(nameof(CustomerRoom));
            builder.HasKey(js => new { js.CustomerRoomId });
